...
export default class DatatableLookup extends LightningElement {
    ...
    get lookupName() {
        console.log("====Name=== this.record =====",this.record.data);
        let lookupNameData = '';
        if(this.record.data != null){
            lookupNameData = this.record.data.fields[this.getFieldName()].value
        } 
        console.log("====lookupNameData=== this.record =====",lookupNameData);
        return lookupNameData;
    }

    //value of formatted url
    get lookupValue() {
        console.log("====Value=== this.record =====");
        console.log("====Value=== this.record =====",this.record.data);
        let lookupValueData = '';

        if(this.record.data != null && this.record.data.fields[this.getFieldName()].value){
            lookupValueData = '/'+ this.value
        }
        console.log("====lookupValueData=== this.record =====",lookupValueData);
