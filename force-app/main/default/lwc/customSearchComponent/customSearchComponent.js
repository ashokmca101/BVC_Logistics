...
import fetchLookupData from '@salesforce/apex/ShippmentCustomLookupController.fetchLookupData';
...
export default class CustomSearchComponent extends LightningElement {
  ...
  // @api setfilterid(myAccountId) {
  //   this.filterId = myAccountId;
  //   console.log('filterid set--', this.filterId);
  //   this.eventfire();
  // }
    @api label = 'custom lookup label';
    @api placeholder = 'search...'; 
    @api iconName = 'standard:location';
    @api sObjectApiName = 'AddressBook__c';
    @api defaultRecordId = '';
    @api recordType='' ;
  ...
  @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName', recType :'$recordType'})
  searchResult(value) {
